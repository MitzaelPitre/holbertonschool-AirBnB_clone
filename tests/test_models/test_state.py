...
class TestStateInstantiation(unittest.TestCase):
    ...
    def test_two_states_unique_ids(self):
        state_instance1 = State()
        state_instance2 = State()
        self.assertNotEqual(state_instance1.id, state_instance2.id)

    def test_two_states_different_created_at(self):
        state_instance1 = State()
        sleep(0.05)
        state_instance2 = State()
        self.assertLess(state_instance1.created_at, state_instance2.created_at)

    def test_two_states_different_updated_at(self):
        state_instance1 = State()
        sleep(0.05)
        state_instance2 = State()
        self.assertLess(state_instance1.updated_at, state_instance2.updated_at)
